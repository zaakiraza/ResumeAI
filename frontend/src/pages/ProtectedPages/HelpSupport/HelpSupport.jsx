...
import { FaQuestionCircle, FaEnvelope, FaBug, FaLightbulb, FaComments, FaCheckCircle, FaTimes, FaBook, FaVideo, FaHeadset } from 'react-icons/fa';
  ...
  const faqItems = [
    {
      ...
      answer: 'Click on "Create Resume" from your dashboard, fill in your information step by step, choose a template, and download your professional resume.'
    },
    {
      question: 'Can I edit my resume after creating it?',
      answer: 'Yes! Go to "My Resumes", find your resume, and click the edit icon. You can modify any section and save your changes.'
    },
    {
      question: 'How many resume templates are available?',
      answer: 'We offer 4 professional templates: Modern, Classic, Creative, and Minimal. Each template can be customized with your data.'
    },
    {
      question: 'Can I download my resume in different formats?',
      answer: 'Currently, you can download your resume as a PDF. We\'re working on adding more format options soon.'
    },
    {
      question: 'How do I use the AI tools?',
      answer: 'Navigate to "AI Tools" from your dashboard. Select the tool you need (resume optimization, cover letter generation, etc.) and follow the prompts.'
    },
    {
                ...
                {quickHelpCards.map((card, index) => (
                  <div
                    ...
                    onClick={() => {
                      ...
                      document.getElementById('help-form').scrollIntoView({ behavior: 'smooth' });
                    }}
                  >
              ...
              {submitStatus === 'success' && (
                <div className="submit-message success">
                  ...
                  <div>
                    ...
                    <p>We've received your help request and will get back to you soon.</p>
                  </div>
              ...
              {submitStatus === 'error' && (
                <div className="submit-message error">
                  ...
                  <div>
                    ...
                    <p>{apiError || 'Please fill in all required fields and try again.'}</p>
                  </div>
                  <button onClick={() => setSubmitStatus(null)}>
                    <FaTimes />
                  </button>
              ...
              <form onSubmit={handleSubmit} className="help-form">
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    />
                    <small className="form-hint">Leave blank to use your account email</small>
                  </div>
